...
int main(int argc, char** argv) {
    //读取视频
    VideoCapture capture("/home/q/CLionProjects/CarND-Advanced-Lane-Lines/harder_challenge_video.mp4");
...
void abs_sobel(Mat &img ,char orient='x', int  min=35 ,int max=100)
{
    Mat gray;
